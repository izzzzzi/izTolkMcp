...
> Source: https://docs.ton.org/languages/tolk/features/standard-library
> Complete reference for all standard library functions and modules.
...
Manages nested tuple-based list structures (cons lists). Functions include:
